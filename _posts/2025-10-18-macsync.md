...
I recently came across a malicious file `update` that appeared to be related to the MacSync InfoStealer. Through some initial research and community outreach, I was able to stumble across what was _very likely_ the initial `curl` command served to users by a malicious `Paste & Run` webpage:
...
> Caveat: I will be sharing bits and pieces of the AppleScript here, however, I will not be sharing the whole thing. It is publicly available online if you look around enough. 
{: .prompt-info }
...
### MacSync Suspicious Curl Usage Masqueradin as Windows
